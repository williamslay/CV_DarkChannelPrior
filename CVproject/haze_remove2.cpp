...
int main()
{
    ...
    imwrite("./img/darkChannel.png", darkChannel);
    ...
    Mat trans = getTransmission_dark(convertImage, normalDark, A, 3);
    cout << "tansmission estimated and guided filtered." << endl;
    //trans.convertTo(trans, CV_8UC3, 255);
    imshow("filtered t", trans);
    imwrite("./img/filteredImage.png", trans);
    ...
    imwrite("./img/finalImage.png", finalImage);
    destroyAllWindows();
    image.release();
